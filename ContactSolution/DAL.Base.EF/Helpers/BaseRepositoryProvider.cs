...
namespace DAL.Base.EF.Helpers
{
    ...
    where TDbContext: DbContext
    {
        ...
        {
            if (_repositoryCache.ContainsKey(typeof(IBaseRepository<TDALEntity>)))
            {
                return (IBaseRepository<TDALEntity>) _repositoryCache[typeof(IBaseRepository<TDALEntity>)];
            }
            // didn't find the repo in cache, lets create it
            ...
            _repositoryCache[typeof(IBaseRepository<TDALEntity>)] = repo;
